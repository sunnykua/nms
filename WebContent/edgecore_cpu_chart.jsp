...
function ClearData() {
	...
	dataset = [        
    { label: "hostCPU", data: hostCPU, lines:{ lineWidth:1.2}, color: "#00FF00" },
    ];
...
function GetData() {
    ...
    $.ajax({
    	//async: false,
        url: "SystemInfo?chart=edgeCoreCpu",
...
function update(response) {
    ...
    now += 10000;
    hostCPU.push([now, response]);
	
	dataset = [
               { label: "CPU", data: hostCPU, lines: {  lineWidth: 1 }, color: "#BBFF00" },
               ];
