...
<title>AC Log ${param.remote_address} ${param.remote_device_ip}</title>
					...
					.datepicker(
							{
								...
								onSelect : function(dateText, inst) {
									window.location.href = "remote_wlan_ac_log.jsp?remote_address=${param.remote_address}&remote_device_ip=${param.remote_device_ip}&level="
