...
function ClearData() {
	...
	dataset = [        
	{ label: "Rx", data: rxData, lines:{ lineWidth:1.2}, color: "#00FF00" },
	{ label: "Tx", data: txData, lines: { lineWidth: 1.2}, color: "#FF0000" },
...
<!-- <p>Port Select:
<select id="port_select" style="witdth: 20px;">
...
<c:out value="<script>$(document).ready(go_chart('${param.ip}', '${param.port}', '${timeout}'));</script>" escapeXml="false"></c:out>
